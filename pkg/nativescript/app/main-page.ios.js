...
function onNavigatingTo(args) {
    ...
    vm.set("webViewSrc", "http://localhost:8888");
...
function onWebViewLoaded(webargs) {
    ...
    application.ios.addNotificationObserver(UIKeyboardWillShowNotification, function (notification) {
        webview.ios.endEditing(true);
    })
