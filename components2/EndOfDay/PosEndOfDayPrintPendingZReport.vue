        ...
        <g-dialog eager v-model={dialog} width="45%" overlay-color="#6B6F82" overlay-opacity="0.95" >
          <div class="print-confirm-dialog" >
            ...
            <div class="confirmation-content" >
              <p>
                { t('report.pendingPrintLine1', { date: formatDate(pendingReport && pendingReport.date) }) } </p>
              <p>
                { t('report.pendingPrintLine2', { date: formatDate(pendingReport && pendingReport.date) }) } </p>
            </div>
