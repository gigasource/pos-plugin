module.exports = {
  vn: {
    ...
    report: {
      ...
      subtotal: 'Trước thuế',
      tax: 'Thuế',
      cancelledTotal: 'Tổng huỷ đặt',
      xReport: 'Báo cáo',
      productSold: 'Hàng hoá bán',
      printReport: 'In hoá đơn',
      pendingPrintLine1: 'ngày {date} chưa được chốt.',
      pendingPrintLine2: 'Bạn có muốn chốt sổ vào ngày {date} không?',
      confirmationPrintZ1: 'Bạn có chắc chắn in báo cáo cuối ngày không?',
      confirmationPrintZ2: '(Báo cáo cuối ngày)',
      reprintZReport: 'In lại báo cáo cuối ngày',
      runEndOfDay: 'Chốt sổ',
      showProductSold: 'Hiện hàng hoá đã bán',
      showZ: 'Hiện tất cả số Z',
      from: 'Từ',
      to: 'Đến',
      //staff
