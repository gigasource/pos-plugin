module.exports = {
  ...
  files: [
    ...
    {loader: {type: 'route'}, filePath: 'components2/Modifiers/dialogEditPopupModifier/dialogEditPopupModifiers.vue', name: 'Modifier', path: '/pos-modifier'},
    ...
    {loader: {type: 'route'}, filePath: 'components2/Payment/Payment.vue', name: 'Payment', path: '/pos-payment'},
    ...
    {loader: {type: 'route'}, filePath: 'components2/EditMenuCard/EditMenuCard.vue', name: 'EditMenuCard', path: '/pos-edit-menu-card'},
    {loader: {type: 'route'}, filePath: 'components2/OrderView/Order.vue', name: 'Order', path: '/pos-order/:id?'},
