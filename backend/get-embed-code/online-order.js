(function () {
  ...
  function getEmbed() {
    ...
    function openIframe () {
      ...
      const isOldIOs = checkIOs12AndLess()
      if(isOldIOs) {
        window.open(url)
      } else {
        ...
        if (existingIframe) {
          ...
          container.setAttribute('style', 'position: fixed; z-index: 1000000; top: 0; left: 0; bottom: 0; right: 0; background: rgba(0, 0, 0, 0.25); backdrop-filter: blur(1.5px); visibility: visible;-webkit-overflow-scrolling: touch; overflow: auto')
    ...
    //open by href #webshop-btn
    var btns = document.querySelectorAll('a[href="#webshop-btn"]')
