...
export default {
  ...
  setup(props, { emit }) {
    ...
    const numpad = computed(() => ([
      ...
      { content: [], icon: 'mdi-refresh', classes: 'key-number bg-white ba-blue-9 ba-thin', action: onClear, style: 'grid-area: keyClear; width: 100%; height: 100%; border: 1px solid #979797; text-align: center' },
