...
import { deleteInventory } from './inventory-logic-be';
        ...
        {genScopeId(() => (
            <>
              ...
              <tbody>
                {/*filter*/}
	              <tr>
	                <td class="bg-grey-lighten-1" style="position: sticky; top: 42px; z-index: 1">
	                  {
	                ...
	                <td colSpan="6" class="filter-wrapper" style="position: sticky; top: 42px">
	                  <div class="filter">
	                    {t('settings.filter')}
