<template>
  <g-btn :uppercase="false" background-color="white" text-color="#1d1d26"
         :disabled="isMoveBtnDisabled(selectedCategory)" class="mr-3" @click="moveCategory('down')">
  ...
  <g-btn :uppercase="false" background-color="white" text-color="#1d1d26"
         :disabled="isMoveBtnDisabled(selectedCategory, true)" class="mr-3" @click="moveCategory('up')">
    <g-icon class="mr-2" svg size="18">
      icon-move-up
    </g-icon>
    {{$t('settings.moveUp')}}
  </g-btn>
  <g-btn :uppercase="false" background-color="white" text-color="#1d1d26" :disabled="isBtnDisabled(selectedCategory)"
         class="mr-3" @click="openDialogEditCategory">
  ...
  <g-btn :uppercase="false" background-color="white" text-color="#1d1d26"
         :disabled="isBtnDisabled(selectedCategory, true)" class="mr-3" @click="openDialogDelete">
  ...
  <dialog-confirm-delete type="Category" :label="selectedCategory ? selectedCategory.name : ''"
                         v-model="dialogConfirmDelete" @submit="deleteCategory"/>
</template>
